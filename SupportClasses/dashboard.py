...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btnExit.setMinimumSize(QtCore.QSize(150, 25))
        self.btnExit.setMaximumSize(QtCore.QSize(150, 25))
        self.btnExit.setObjectName("btnExit")
        self.verticalLayout.addWidget(self.btnExit, 0, QtCore.Qt.AlignHCenter)
